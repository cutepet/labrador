package io.github.cutepet.labrador.japidocs.plugin.rap;
...
import io.github.cutepet.labrador.japidocs.http.DHttpRequest;
import io.github.cutepet.labrador.japidocs.http.DHttpResponse;
import io.github.cutepet.labrador.japidocs.http.DHttpUtils;
...
public class RapSupportPlugin implements IPluginSupport {
    ...
    public void execute(HtmlDocGenerator docGenerator) {
        this.controllerNodeList = docGenerator.getControllerNodeList();
        postToRap();
    }
    /**
     * do post
    ...
    private void postToRap(){
        ...
        if(controllerNodeList == null
            ...
            LogUtils.warn("docs com.example.test.config properties miss, we don't think you want to post to rap!");
            return;
        }
